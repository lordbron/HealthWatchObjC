...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"sourcesCell" forIndexPath:indexPath];
    
    // Configure the cell...
    HKSource *currentSource = [self.tableData objectAtIndex:indexPath.row];
    cell.textLabel.text = currentSource.name;
